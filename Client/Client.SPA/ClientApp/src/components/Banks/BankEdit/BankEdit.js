...
var BankEdit = react_1.memo(function (_a) {
    ...
    react_1.useEffect(function () {
        ...
        if (updatedForm && isInitializing) {
            updatedForm = __assign(__assign({}, updatedForm), (_a = {}, _a['name'] = __assign(__assign({}, updatedForm['name']), { value: bank.name, valid: true }), _a['grade'] = __assign(__assign({}, updatedForm['grade']), { value: (_b = bank.grade) === null || _b === void 0 ? void 0 : _b.toString(), valid: true }), _a));
    ...
    react_1.useEffect(function () {
        switch (successfulOperation) {
            case enums_1.SuccessfulOperation.Update:
                cancelHandler();
                break;
            case enums_1.SuccessfulOperation.Delete:
                setRedirect(React.createElement(react_router_dom_1.Redirect, { to: "/banks/" }));
            default:
        }
    }, [successfulOperation]);
    ...
    var changeStarsHandler = function (value, id) {
        var _a;
        var updatedForm = __assign(__assign({}, formControls), (_a = {}, _a['stars'] = __assign(__assign({}, formControls['stars']), { value: value }), _a));
        setFormControls(updatedForm);
    };
