...
var initialFormState = {
    email: {
        ...
        elementConfig: {
            type: enums_1.ElementConfigTypeEnum.Email,
            placeholder: 'Email',
        },
    ...
    password: {
        elementType: enums_1.ElementTypeEnum.Input,
        elementConfig: {
            type: enums_1.ElementConfigTypeEnum.Password,
...
var Auth = function () {
    ...
    var form = (React.createElement("form", { onSubmit: signInHandler },
        ...
        React.createElement(Button_1.default, { type: enums_1.ButtonTypeEnum.Success, disabled: !isFormValid || isLoading }, "Sign In")));
