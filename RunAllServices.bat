cd "H:\Project\Microservices\MicroservicesSampleProject\APIManager\APIManager.APIGateway"
start LaunchAPIGateway.bat
cd "H:\Project\Microservices\MicroservicesSampleProject\Microservices\CRUD\CRUD.APIService\"
